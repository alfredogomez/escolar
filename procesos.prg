...
*-------------------------------------------------------
* Este módulo hace una serie de procesos de limpieza y mantenimiento a la base
* de datos del plantel (no afecta a las bases de datos de las coordinaciones ni
* la base de datos de oficinas generales, siguiendo la política de que en dichas
* bases de datos debe reflejarse exactamente lo que hay en el plantel ya sea que 
* allí esté mal o bien no importa, lo que importa es que esté exactamente igual.)
* Esto funciona como la integridad de la información, pero la diferencia es que este
* proceso se corre automático cada vez que se inicia el sistema, también justo antes
* de enviar un respaldo y también antes de imrpimir actas ordinarias o extraordinarias.
*-----------------------------------------------------
...
* CORREGIR CICLO-GENERACIÓN EN LA TABLA alumnos.
